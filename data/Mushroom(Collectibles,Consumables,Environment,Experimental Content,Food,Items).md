...
The Mushroom can be obtained by picking it up anywhere in the world. Just move the cursor over the mushroom on the ground, and press "Use".
# Trivia

The name of the item is Mushroom; however when the player mouses over a mushroom in the world it will show as a Wild Mushroom.
Being easy to find, mushrooms are okay for nourishing players who do not have the resources to hunt.
# Gallery

A mushroom as it can be found in the game.A mushroom that can be picked up by the player.
Items
Ammunition
