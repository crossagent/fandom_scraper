...
The Nailgun requires at least a Work Bench Level 1 and can be crafted with:
75 Metal Fragments
15 Scrap
# Trivia

It's one of the least used weapons, (apart from the Eoka Pistol) because of the short range and low damage in each shot fired.
It behaves similar to a Bow in bullet physics, but in firing mechanics, it is totally different.
It has extremely high bullet drop and is only good for close range encounters against lightly armed opponents.
Nailguns can be used to destroy twig structural items such as walls and ceiling tiles.
Nailgun Nails can be retrieved similar to Wooden Arrows after being fired.
Items
Ammunition
