...
While the Pistol Bullet's caliber is not explicitly stated, it is assumed to be 9×19mm Parabellum. This is supported by Face Punch artist Thomas Butters publishing the Revolver as the 9mm revolver on his ArtStation account in 2015. However, with the magazine capacity (8) of the semi-automatic pistol and it's use in the Thompson, it could potentially be .45ACP. Based on 3D assets from the base game this caliber is among the most likely, however the proportions and the lack of an extracting groove on the casing for the inventory art suggests it could also be the .22 Long.
# Researching
...
↑ 9×19mm Parabellum
↑ https://www.artstation.com/fgsltw
