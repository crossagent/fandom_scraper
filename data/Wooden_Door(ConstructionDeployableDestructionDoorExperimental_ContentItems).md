...
It is advised not to use Timed Explosive Charges on Wooden Doors, since they are easily damaged by other more cost efficient means. The more efficient ways to raid wooden doors are with handmade shells and other bullets. It is best to use an eoka pistol when raiding wooden doors because it uses handmade shells and the eoka's fireing sound does not travel as far as shotguns. Flame Throwers are a somewhat expensive but extremely fast option; it can sometimes be tricky to make the flames accumulate at the bottom of the door to burn it.
# Crafting

The Wooden Door can be crafted with:
300 Wood
The Wooden Door takes 30 seconds to craft.
# Skins
