...
Crafting a Bear Trap takes 60 seconds and requires:
50 Metal Fragments
1 Gears
Notes:
...
When placed in a Recycler, snap traps will yield:
25 Metal Fragments
1 Gear (~30% chance)
# Trivia

You can deactivate the trap if you hit the central plate marked X with an arrow, a bullet or melee weapon.
# Gallery
