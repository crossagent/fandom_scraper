...
The Small Water Bottle could be consumed by a player by putting it into their Hotbar and pressing the specified key of 1-6. Players could could also consume it from anywhere in their inventory by hovering their mouse over the item and then clicking on it with their right-mouse button after which they could select the Consume option.
# Obtaining

The Small Water Bottle could be obtained in the following way:
By looting Rad Animals;
Finding them in Wooden Loots Crates.
Legacy Items
Ammo
