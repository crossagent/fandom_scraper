...
The Medium Present is a festive, consumable, seasonal item that can only be found during the Christmas season. It can be crafted (but is not shown on the crafting menu), and is collected from Christmas themed loot drops. Similar to Blueprint Fragments, you can either redeem it for loot, or collect 5 of them to upgrade to a Large Present.
# How to acquire

The Medium Present can be made from 10 Small Presents or collected from Christmas themed loot drops.
# Possible Loot
