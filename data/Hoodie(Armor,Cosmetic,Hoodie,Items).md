...
The Red Hoodie can be crafted with:
80 Cloth
1 Sewing Kit
Notes:
It takes 30 seconds to craft one Hoodie.
# Recycling
...
Due to this clothing item having a highly similar appearance to the Leather Vest in Legacy and the implementation of skins, it is possible to replicate (but not have the protection of) the leather armor set from Legacy by wearing this, a Beenie Hat (No skin), Pants (Blue Jeans skin) and Boots (Either no skin or Tan Boots skin).
Items
Ammunition
