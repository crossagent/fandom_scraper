...
Wood is harvested from using tools like the Rock, Salvaged Axe, Hatchet, Stone Hatchet and Chainsaw against standing Trees or scattered logs and branches. Some other tools can be used but lose durability much faster and with less yield per hit.
It can also be found laying around in the world in form of tree stumps. Those can be picked up and will yield 50 wood.
# Uses

Building structures
Crafting items
Repairing items
Fuel for Camp Fires, Small Oil Refineries and Furnaces
# Gallery

Wood being gathered from a Tree with a Hatchet.Wood stump that can be picked up.
Items
Ammunition
