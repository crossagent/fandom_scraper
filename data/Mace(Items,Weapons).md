...
The Mace can be crafted with:
100 Wood
50 Metal Fragments
Notes:
It takes 60 seconds to craft one Mace.
It can be thrown up to 9 meters.
It can down someone in one hit to the head with no armor
it is considerably the best melee in the game
Items
Ammunition
