...
The Large Water Catcher is used to obtain water from various weather phenomena, such as rain, fog or snow. Once it is placed, it will passively collect water from the moisture in the air at a slow rate. This water can then be consumed directly or stored in a container such as a Bota Bag or a bottle. Water can also be removed in larger quantities by using a Water Bucket or a Water Jug. 
The Large Water Catcher is not advised if bulk water collection is needed. 4 Small Water Catchers will likely be more effective, although they will cost more. However, the Large Water Catcher takes longer to fill up, making it useful for collecting resources during time when one is disconnected. 
Items
Ammunition
