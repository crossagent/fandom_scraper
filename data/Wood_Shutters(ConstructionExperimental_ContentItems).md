...
The Wood Shutters can be crafted with:
200 Wood
It takes 30 seconds to craft a single pair of Wood Shutters.
# Trivia

When closed, the Wood Shutters will obstruct virtually all of the window, although it is possible to peer through small cracks in it.
Even with Shutters already installed on the window, it is still possible to place window bars in the window.
Warning to base owners: the Wood Shutters can be opened and closed from EITHER SIDE of the window.
You can shoot projectiles through the gap of the closed shutters.
Items
Ammunition
