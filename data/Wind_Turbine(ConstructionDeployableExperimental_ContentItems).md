...
It can be found in Locked Crates, Elite Tier Crates, Military Crates and corpse of Oil Rig and Heavy Scientists.
## Crafting

Once obtained and researched, it can be crafted while in AoE of a Workbench Level 2 using:
1500 Wood
30 HQM
3 Gears
10 Sheet Metal
...
Placing the Wind Turbine as high as possible is very recommended, since height has a major effect on its efficiency.
It has 1 place to plug the Wire Tool into, the output. It generates a maximum of 150rWm but it consumes 1rWm, so the minimum output is 1rWm.
It cannot be picked up after it has been placed.
# Durability

It has a maximum of 250HP.
It can be repaired with the Hammer, using its crafting materials.
# Wind Turbine Video Guide

 Placing 119 Wind Turbines to Learn How They Actually Work 
Items
Ammunition
