...
Crafting a Landmine takes 60 seconds and requires:
50 Metal Fragments
100 Gun Powder
# Recycling
...
Once triggered and/or disarmed, the Landmine can be picked up by another player, the player has to stay there until another player comes to pick up the landmine.
The Landmine goes off only after the player/entity steps OFF of it. It does not go off instantly as it is stepped on.
The Landmine will displace grass if it is placed in a grassy area.
If Killed from a landmine, some of the items in your inventory will be destroyed (Not Fixable or re-attain able.)
Items
Ammunition
