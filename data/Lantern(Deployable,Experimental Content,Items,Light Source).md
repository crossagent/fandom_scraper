...
The Lantern can be crafted with:
50 Metal Fragments
15 Low Grade Fuel
Notes:
It takes 60 seconds to craft one Lantern.
The Lantern lasts 10 minutes per each Low Grade Fuel.
You can calculate how long your Lantern will last by using: (Amount of LGF) / 6 This will tell you how long it will last in hours.
Can be broken using bullets.
# Gallery

Lantern in game.Rust lantern
Items
Ammunition
