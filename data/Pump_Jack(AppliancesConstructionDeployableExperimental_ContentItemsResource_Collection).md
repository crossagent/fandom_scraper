...
Similar to the Mining Quarry, but instead the output is Crude Oil. Once fuel is put in, its engine can be started and the Pump Jack will operate until turned off or it runs out of fuel. Over time the Pump Jack will automatically pump Crude Oil which can then be collected.
# Crafting

Pumpjacks became no longer craftable as a deployable object as of Devblog #87.
# Gallery

Close up on a component of the oil derrick.Developer screenshot of the oil derrick.
# Trivia

The Pump Jack makes a significant amount of noise. It is easily spotted from afar, and the movement of its parts give a clear indication that it is in use. It can easily attract attention from other players.
Items
Ammunition
