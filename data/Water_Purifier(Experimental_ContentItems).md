...
The Water Purifier can be crafted with:
1 Empty Propane Tank
15 Metal Fragments
10 Cloth
It takes 30 seconds to craft one Water Purifier.
# Usage

A notable thing to remember when using the Water Purifier is that it has two inventories; an input, and an output. Salt Water must be placed into the tank itself, while the bucket is the inventory wherein the purified Water enters after cooking. You know it's working when the tank is getting slowly drained and the bucket slowly fills.
Items
Ammunition
