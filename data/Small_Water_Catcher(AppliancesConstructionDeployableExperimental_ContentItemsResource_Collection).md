...
The Small Water Catcher is used to obtain Water. Once it is placed, it will slowly collect Water over time, which can then be consumed directly or stored in a container such as a Bota Bag. Water can also be removed in larger quantities by using a Water Bucket.
# Trivia

The Small Water Catcher accumulates Water slower than its bigger counterpart, the Large Water Catcher, however it takes up considerably less space and can be placed on building blocks.
# Using Water Catchers to Farm
