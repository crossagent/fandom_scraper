...
The High External Wooden Wall can be crafted with:
1500 Wood
Notes:
It takes 7-30 seconds to craft one wooden wall at a Teir 1 workbench.
The wall has a health of 500.
It takes 2 Timed Explosive Charge to break. 1 charge will remove 495 health.
Weak protection from fire
It takes 125 scrap to research in the Research Table.
# Usage

The wall is used to block your base from raiders. Also can be used to create a nicer look to your base. 
Items
Ammunition
