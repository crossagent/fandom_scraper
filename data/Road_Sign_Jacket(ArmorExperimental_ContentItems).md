...
The Road Sign Jacket is not known by default. It takes 60 seconds and a tier two workbench to craft one with the following materials:
40 Leather
3 Road Signs
3 Sewing Kit
# Skins
...
The back of the Road Sign Jacket says "Top Kek"
It is similar to, and may have been inspired by the makeshift roadsign armor found in the Fallout: New Vegas downloadable content "Lonesome Road" which is also most likely based on Mad Max and other "post apocalyptic / road warrior" etc type pop culture.
Originally when this item was made, it took up both the under and over layer of the torso. Now, it can be worn with an applicable shirt.
Items
Ammunition
