...
The Large Present
is a festive, consumable, seasonal item that can only be found during the Christmas season. Upon opening, the player will get high value items (see below).
# How to acquire

It can only be upgraded from 5x Medium Presents. Can be found in barrels
# Possible Loot
