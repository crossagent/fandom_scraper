...
The Muzzle Boost will increase a weapon's rate of fire by 50%. Auxillary actions such as manually cycling or charging the weapon, as is the case with the Bolt Action Rifle and Pump Shotgun will also be hastened. Reloading speed, however, remains unaffected.
Bullet velocity will be slightly decreased resulting in barely discernible, and in terms of performance otherwise irrelevant, increased bullet travel time. Due to the reduced bullet velocity, bullets will suffer a ~12% damage penalty.
Accuracy is not directly affected by the Muzzle Boost. The amount of recoil remains the same throughout, however, the gun barrel will rise faster due to the increased rate of fire.
# Crafting

The Muzzle Boost can be crafted with:
10 High Quality Metal
# Trivia

Due to the Muzzle Boost being positioned on the muzzle, it CANNOT be used in conjunction with a Muzzle Brake or a Silencer.
# Gallery

A rendering of the Muzzle Boost.
Items
Ammunition
