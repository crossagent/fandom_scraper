...
Simply put the Large Medkit onto your hotbar and press the corresponding number that is assigned to whatever place you put the Large Medkit onto your hotbar, or by Left-Clicking the item in your Inventory and then clicking on "Use".
# Obtaining

Large Medkits can be looted from Air Supply Drops or Military Crates.
# Crafting

The Large Medkit can be crafted with:
2 Medical Syringes
50 Low Grade Fuel
Notes:
It takes 30 seconds to craft one Large Medkit.
## Recycling

When recycled, a Large Medkit will yield: 
1 Medical Syringe, 5 Low Grade Fuel
# Trivia

The in-game description of Blood refers to it being needed in the creation of Medkits. Blood is currently not present in the Experimental version of Rust.
The name ' Large Medkit' implies that there is a smaller type of Medkit. There was Small Medkit in Rust Legacy. However, it is not currently available in the experimental version.
The Medkit icon is similar to the one used in Rust Legacy.
Items
Ammunition
